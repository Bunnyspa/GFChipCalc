...
public class TagPanel extends JPanel {
    ...
    private void init() {
        addButton.setText(app.getText(AppText.ACTION_ADD));
        colorButton.setText(app.getText(AppText.CHIP_COLOR));
        applyButton.setText(app.getText(AppText.ACTION_APPLY));
